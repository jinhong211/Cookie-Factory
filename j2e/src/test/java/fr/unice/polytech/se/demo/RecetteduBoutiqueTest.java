...
public class RecetteduBoutiqueTest {
    @Deployment
    public static Archive<?> createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "test.war")
                .addPackage(RecettesduBoutique.class.getPackage())
                .addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml")
                .addAsWebInfResource("META-INF/persistence.xml", "persistence.xml")
                .addPackage(RecettesduBoutique.class.getPackage())
                .addPackage(RecettesduBoutiqueBean.class.getPackage());
    }

    @EJB
    private RecettesduBoutique managerR;
    ...
    public void testCreation() {
        ...
        Commande commande2=managerPC.createCommande(boutique, recette2, new Date(0, 0, 0), 10);

        Set<Commande> commandes = new HashSet<Commande>();

        commandes = managerR.getRecettesduBoutique("Polytech");
